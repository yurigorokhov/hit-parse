...
*/(function($) {
    ...
    Hit.Venue = function(data) {
        ...
        this.pictures = data.attributes.pictures || [ ];
    };
            ...
            xhr.onreadystatechange = function(e) {
                if(xhr.readyState && xhr.readyState == 4) {
                    if(xhr.status >= 200 && xhr.status < 300) {
                        ...
                        self.pictures.push(response.url);
                        self._parseVenue.set('pictures', self.pictures);
                        self._parseVenue.save(null, {
                            success: function(venue) {
                                def.resolve(new Hit.Venue(venue));
                            },
                            error: function(venue, error) {
                                def.resolve(venue, error);
                            }
                        });
                    } else {
                        def.reject(e);
