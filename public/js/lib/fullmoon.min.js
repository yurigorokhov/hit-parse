...
// Parse Init
Parse.initialize("Gjy5f0o2limWmCwEZXBwYi3EUULEVfZWZo6OZ2GQ", "eZ3hgT3pUwU9N31UVyqKsRDYAFRJJEQYUWKztnoq");
...
*/(function($) {
    ...
    _(Hit.Venue).extend({
        ...
        searchByNameAndLocation: function(name, location) {
            ...
            q.matches('name', name).withinMiles('location', point, 10).limit(10)
            .find({
